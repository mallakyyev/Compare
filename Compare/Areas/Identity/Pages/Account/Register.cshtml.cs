...
namespace Compare.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            //Google Recaptcha
            //var googleRecaptcha = _googleReCaptchaService.VerifyCaptcha(Input.Token);
            //if (!googleRecaptcha.Result.success)
            //{
            //    ModelState.AddModelError(string.Empty, "Вы не человек");
            //    return Page();
            //}
