...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Compare.DAL.Models.Bookmarks.Bookmark", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Compare.DAL.Models.Cart.Basket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int?>("OrderOrganizationId")
                        .HasColumnType("integer");

                    b.Property<int>("OrganizationProductId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("OrderOrganizationId");
            ...
            modelBuilder.Entity("Compare.DAL.Models.Cart.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Compare.DAL.Models.Cart.OrderOrganization", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Compare.DAL.Models.Catalog.CategoryPanel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("CategoryPanels");
                });

            modelBuilder.Entity("Compare.DAL.Models.Catalog.CategoryPanelAndProduct", b =>
                {
                    b.Property<int>("CategoryPanelId")
                        .HasColumnType("integer");

                    b.Property<int>("ProductId")
                        .HasColumnType("integer");

                    b.HasKey("CategoryPanelId", "ProductId");

                    b.HasIndex("ProductId");

                    b.ToTable("CategoryPanelAndProducts");
                });

            modelBuilder.Entity("Compare.DAL.Models.Catalog.CategoryPanelTranslate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("CategoryPanelId");

                    b.ToTable("CategoryPanelTranslates");
                });
            ...
            modelBuilder.Entity("Compare.DAL.Models.Commentary.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Compare.DAL.Models.Company.OrganizationProduct", b =>
                {
                    ...
                    b.Property<string>("OrganizationProductUrl")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Compare.DAL.Models.Commentary.ProductComment", b =>
                {
                    b.HasBaseType("Compare.DAL.Models.Commentary.Comment");
            ...
            modelBuilder.Entity("Compare.DAL.Models.Commentary.StoreComment", b =>
                {
                    b.HasBaseType("Compare.DAL.Models.Commentary.Comment");
                    ...
                    b.HasDiscriminator().HasValue("StoreComment");
                });
            ...
            modelBuilder.Entity("Compare.DAL.Models.Bookmarks.Bookmark", b =>
                {
                    b.HasOne("Compare.DAL.Models.User.ApplicationUser", "ApplicationUser")
                        .WithMany("Bookmarks")
                        .HasForeignKey("ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Compare.DAL.Models.Company.Organization", null)
                        .WithMany("Bookmarks")
            ...
            modelBuilder.Entity("Compare.DAL.Models.Cart.Basket", b =>
                {
                    ...
                    b.HasOne("Compare.DAL.Models.Cart.OrderOrganization", "OrderOrganization")
                        .WithMany("Baskets")
                        .HasForeignKey("OrderOrganizationId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Compare.DAL.Models.Company.OrganizationProduct", "OrganizationProduct")
                        .WithMany("Baskets")
                    ...
                    b.Navigation("OrderOrganization");
            ...
            modelBuilder.Entity("Compare.DAL.Models.Cart.OrderOrganization", b =>
                {
                    b.HasOne("Compare.DAL.Models.Cart.Order", "Order")
                        .WithMany("OrderOrganizations")
            ...
            modelBuilder.Entity("Compare.DAL.Models.Catalog.CategoryPanelAndProduct", b =>
                {
                    b.HasOne("Compare.DAL.Models.Catalog.CategoryPanel", "CategoryPanel")
                        .WithMany("CategoryPanelAndProducts")
                        .HasForeignKey("CategoryPanelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Compare.DAL.Models.Catalog.CategoryPanelTranslate", b =>
                {
                    b.HasOne("Compare.DAL.Models.Catalog.CategoryPanel", "CategoryPanel")
                        .WithMany("CategoryPanelTranslates")
                        .HasForeignKey("CategoryPanelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Compare.DAL.Models.Cart.Order", b =>
                {
                    b.Navigation("OrderOrganizations");
                });
            ...
            modelBuilder.Entity("Compare.DAL.Models.Catalog.CategoryPanel", b =>
                {
                    b.Navigation("CategoryPanelAndProducts");

                    b.Navigation("CategoryPanelTranslates");
                });
